        ...
        for (did, dname) in disease_list {
            ...
            for (sym_name, freq, is_pathognomonic) in sym_list {
                ...
                if input_set.contains(sym_name.as_str()) {
                    ...
                    // 核心症状（pathognomonic）给予 1.5 倍权重加成
            ...
            // disease_coverage: 该疾病症状库中匹配的加权比例
